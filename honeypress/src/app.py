...
def checkTor(ip):
    ...
    try:
        exit_nodes = requests.get(
            "https://check.torproject.org/exit-addresses", headers=headers
        )
        ...
        honeyDB.payloads.insert(
            {
                ...
                "requests": {
                    request_id: {
                        ...
                        "attack_meta": analyze_uri(triggered_url),
...
def apply_headers(response):
    ...
    response.headers[
        "Link"
    ] = '<http://wordpress.com/wp-json/>; rel="https://api.w.org/"'
